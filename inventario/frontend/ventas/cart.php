    ...
    <body>
        ...
        <div class="sidebar">
            <div class="side-header">
                <h3>Anita<span>Bazar</span></h3>
            </div>

            <div class="side-content">
                <div class="profile">
                    <div class="profile-img bg-img" style="background-image: url(../../backend/img/ca24.png)"></div>
            ...
            <header>
                <div class="header-content">
                    ...
                    <div class="header-menu">
                        ...
                        <div class="user">
                            <div class="bg-img" style="background-image: url(../../backend/img/ca24.png)"></div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <h4><?= $fetch_cart['codpro']; ?></h4>
                                                </td>
                                                <td>
                                                    <h4><?= $fetch_cart['nomprd']; ?></h4>
                                                </td>
                                                <td>
                                                    <h4>S/<?php echo number_format($fetch_cart['precio'], 2) ?></h4>
                                                </td>
                                                <td>
                                                    <h4><?= $fetch_cart['stock']; ?></h4>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <h4>S/<?= number_format($sub_total = ($fetch_cart['precio'] * $fetch_cart['quantity']), 2); ?></h4>
                                                </td>
