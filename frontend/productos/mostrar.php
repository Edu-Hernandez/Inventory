...
<?php if (isset($_SESSION['id'])) { ?>
    ...
    <head>
        ...
        <link rel="icon" type="image/png" href="../../backend/img/logoucv.jpeg">
    ...
    <body>
        ...
        <div class="sidebar">
            <div class="side-header">
                <h3>Productos<span>UCV</span></h3>
            </div>

            <div class="side-content">
                <div class="profile">
                    <div class="profile-img bg-img" style="background-image: url(../../backend/img/logoucv.jpeg)"></div>
            ...
            <header>
                <div class="header-content">
                    ...
                    <div class="header-menu">
                        ...
                        <div class="user">
                            <div class="bg-img" style="background-image: url(../../backend/img/logoucv.jpeg)"></div>
                            ...
                            <?php if (count($data) > 0): ?>
                                <table width="100%" id="example">
                                    <thead>
                                        <tr>
                                            <th>Código</th>
                                            <th><span class="las la-sort"></span>Nombre Producto</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($data as $d): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <h4><?php echo $d->modelo ?></h4>
                                                </td>
                                                <td>
                                                    <h4><?php echo $d->nocate ?></h4>
                                                </td>
                                                <td>
                                                    <h4>S/<?php echo number_format($d->precio, 2) ?></h4>
                                                </td>
                                                <td>
                                                    <?php
                                                    if ($d->stock < 11) {
